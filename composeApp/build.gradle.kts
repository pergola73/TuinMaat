...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "APP_VERSION", "\"${project.parent?.project(":app")?.extensions?.getByType<com.android.build.api.dsl.ApplicationExtension>()?.defaultConfig?.versionName ?: "3.0.0"}\"")
        buildConfigField("int", "BUILD_NUMBER", "${project.parent?.project(":app")?.extensions?.getByType<com.android.build.api.dsl.ApplicationExtension>()?.defaultConfig?.versionCode ?: 31}")
    }
    compileOptions {
