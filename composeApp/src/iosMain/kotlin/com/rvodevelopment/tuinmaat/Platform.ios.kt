...
actual val appVersion: String = run {
    val version = (NSBundle.mainBundle.infoDictionary?.get("CFBundleShortVersionString") as? String) ?: "3.0.0"
    val build = (NSBundle.mainBundle.infoDictionary?.get("CFBundleVersion") as? String) ?: "31"
    "$version ($build)"
}

// AdMob Test IDs for Version 3.0.0 (iOS)
